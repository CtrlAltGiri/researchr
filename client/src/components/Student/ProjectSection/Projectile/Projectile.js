  ...
  if (props.allItems.desc.length > 300){
    ...
    return (
      <div className="px-4 py-12 md:p-12 md:w-6/12 flex flex-col items-start">
        ...
        <Link to={`/student/project/${props.allItems._id}`}><h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4 hover:underline">{props.allItems.name}</h2></Link>
