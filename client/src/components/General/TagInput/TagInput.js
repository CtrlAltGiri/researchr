...
function TagInputs(props) {
    ...
    return (
        <div className={props.extraClass}>
            ...
            <input type="text" onChange={(e) => setVal(e.target.value)} className={`outline-none focus:border-teal-500 border-2 rounded-lg py-1 px-2 ${props.fieldExtraClass}`} name={props.name} value={val} />
            ...
            <div className="m-4">      
                {chosenTags.length > 0 && <p className="-m-2 font-medium text-gray-800 mb-2">CHOSEN TAGS</p>}          
