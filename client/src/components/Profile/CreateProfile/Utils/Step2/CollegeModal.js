        ...
        <div className="flex flex-col w-full">
            <form className="flex flex-col" onSubmit={props.submitInnerForm}>
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <button className="pr-4 focus:outline-none" onClick={(e) => {closeModal()}}><svg className="svg-icon" viewBox="0 0 20 20">
                ...
                <div className="mb-8">
                    <p className="text-l text-gray-700 px-1 mb-1">Experiences</p>
