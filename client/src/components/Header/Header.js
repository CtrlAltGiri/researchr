...
function Header() {
    ...
    return (
        <header className="md:px-16 px-6 bg-white flex flex-wrap items-center py-8 md:py-4">
            ...
            <div className="hidden md:flex md:items-center md:w-auto w-full" id="menu">
                <nav>
                    <ul className="md:flex items-center justify-between text-base text-gray-700 pt-2 md:pt-0 text-center md:text-left">
                        <li><Link to="/profile" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-teal-500" href="/platform/profile">My Profile</Link></li>
                        <li><a className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-teal-500" href="/platform/applications">Applicants</a></li>
                        <li><a className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-teal-500" href="/platform/faq">Information</a></li>
            ...
            <a href="#" className="md:ml-4 flex items-center justify-start md:mb-0 mb-4 m-auto md:m-0 cursor-pointer">
                <label htmlFor="menu-toggle" className="cursor-pointer md:hidden block">
                    <img className="rounded-full w-10 h-10 border-2 border-transparent hover:border-teal-500" src="images/aboutus/giri.jpg" alt="Giridhar B" />
                </label>
                <img className="rounded-full w-10 h-10 border-2 border-transparent hover:border-teal-500 hidden md:inline" src="images/aboutus/giri.jpg" alt="Giridhar B" />
            </a>
        </header>
