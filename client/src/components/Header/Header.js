    ...
    return (
        <header className="md:px-16 px-6 bg-white flex flex-wrap items-center py-8 md:py-4">
            <div className="flex-1 flex justify-between items-center">
                <Link to="/platform" className="px-8">
            ...
            <div className="hidden md:flex md:items-center md:w-auto w-full" id="menu">
                <nav>
                    <ul className="md:flex items-center justify-between text-base text-gray-700 pt-2 md:pt-0 text-center md:text-left">
                        <li><Link to="/platform/profile" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-teal-500">My Profile</Link></li>
                        <li><Link to="/platform/applications" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-teal-500">Applications</Link></li>
                        <li><Link to="/platform/messages" className="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-teal-500">Messages</Link></li>
